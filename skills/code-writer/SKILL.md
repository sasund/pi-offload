---
name: code-writer
description: "Delegate boilerplate code generation to the local pi agent. Use for tests, config, docstrings, type stubs, or any generation where >80% is predictable from reference files."
---
